...
public class ApiXuClientTest {
  ...
  @Test
  public void givenApiXuForecastRequest_WhenServiceResponseIsOk_ThenResponseIsSuccessful()
      throws IOException, URISyntaxException {

    ForecastRequest input = new ForecastRequest(
        ForecastSource.APIXU, City.BOGOTA, TemperatureUnit.CELSIUS);
    ...
    mockServer.expect(ExpectedCount.once(),
        requestTo(
            new URI(
                "http://localhost:8080/apixu/forecast?key=testApiKey&days=7&q=4.60971,-74.081749")))
  ...
  public void givenApiXuForecastRequest_WhenServiceResponseIsError_ThenExceptionIsRaised()
      throws IOException, URISyntaxException {
  ...
  public void givenApiXuForecastRequest_WhenServiceResponseIsEmpty_ThenExceptionIsRaised()
      throws IOException, URISyntaxException {
